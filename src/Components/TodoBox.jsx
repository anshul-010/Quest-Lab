...
export const TodoBox = ({todoData}) => {
  ...
  function handleAddTodo() {
    ...
    const newTodo = { ...data, id: idString };// Create new todo object with generated ID
    setTodoData([...todoData, newTodo]); // Update todoData state with new todo
    onClose();
  }
